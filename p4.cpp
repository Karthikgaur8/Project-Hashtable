...
public:
  ...
  int get_total_collisions() { return total_collisions; }

private:
  int h1(string key) { return djb2(key) % size; }

  int h2(string key) { return a - (djb2(key) % a); }
...
int main(int argc, char *argv[]) {
  ...
  cout << "The number of words found in the file was "
       << hash_table.get_total_words() << '\n';
  cout << "The number of unique words found in the file was "
       << hash_table.get_distinct_words() << '\n';
